...
Ex) `http://localhost:5000/process/?q=hello` [result](https://github.com/swapagarwal/JARVIS-on-Messenger/tree/master/images/result_hello.png) or `http://localhost:5000/search/?q=joke` [result](https://github.com/swapagarwal/JARVIS-on-Messenger/tree/master/images/result_joke.png) etc...

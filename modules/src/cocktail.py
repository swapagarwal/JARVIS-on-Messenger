...
def process(input, entities):
    ...
    try:
        ...
        cocktail_url = 'http://www.thecocktaildb.com/drink.php?c=' + cocktail_id
        ingredients = ''
        for countIngredients in xrange(1, 16):
            ingredient = 'strIngredient' + str(countIngredients)
            measure = 'strMeasure' + str(countIngredients)
            ingredients += cocktail['strMeasure' + str(countIngredients)] + cocktail[
                'strIngredient' + str(countIngredients)] + '\n'
